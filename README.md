...
# Annotation
sunbeam run --configfile sunbeam_config.yml --cluster "sbatch --job-name=sunbeam_all_annotate --account=of33 --time=3-00:00:00 --mem-per-cpu=8G --ntasks=1 --cpus-per-task=12" -j 25 -w 30 -p all_annotate
