...
sunbeam run --configfile sunbeam_config.yml --cluster "sbatch --job-name=sunbeam_all_annotate --account=of33 --time=3-00:00:00 --mem-per-cpu=16G --ntasks=1 --cpus-per-task=8" -j 200 -w 60 -p all_annotate
