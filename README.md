...
sunbeam run --configfile sunbeam_config.yml --cluster "sbatch --job-name=sunbeam_all_annotate --account=of33 --time=1-00:00:00 --mem-per-cpu=10G --ntasks=1 --cpus-per-task=4" -j 100 -w 60 -p all_annotate
