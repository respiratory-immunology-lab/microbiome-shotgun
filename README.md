...
# Annotation
sunbeam run --configfile sunbeam_config.yml --cluster "sbatch --job-name=sunbeam_all_annotate --account=of33 --time=7-00:00:00 --mem=180G --nodes=1 --ntasks=1 --cpus-per-task=24" -j 500 -w 30 -p all_annotate
