...
# Annotation
sunbeam run --configfile sunbeam_config.yml --cluster "sbatch --job-name=sunbeam_all_annotate --account=of33 --time=7-00:00:00 --mem-per-cpu=15G --nodes=1 --ntasks=1 --cpus-per-task=6" -j 200 -w 60 -p all_annotate
