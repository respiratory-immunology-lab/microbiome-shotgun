...
# Annotation
sunbeam run --configfile sunbeam_config.yml --cluster "sbatch --job-name=sunbeam_all_annotate --account=of33 --time=3-00:00:00 --mem-per-cpu=4G --ntasks=1 --cpus-per-task=24" -j 50 -w 30 -p all_annotate
